...
import org.grobid.trainer.sax.TEIRespondentSaxParser;
...
public class NameRespondentTrainer extends AbstractTrainer {

    public NameRespondentTrainer() {
        super(GrobidModels.NAMES_RESPONDENT);
    }
	...
	public int createCRFPPData(final File corpusDir, 
		...
		try {
			...
			for (; n < refFiles.length; n++) {
				...
				final TEIRespondentSaxParser parser2 = new TEIRespondentSaxParser();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Trainer trainer = new NameRespondentTrainer();
