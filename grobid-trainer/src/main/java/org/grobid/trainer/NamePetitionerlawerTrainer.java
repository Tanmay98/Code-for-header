...
import org.grobid.trainer.sax.TEIPetitionerlawerSaxParser;
...
public class NamePetitionerlawerTrainer extends AbstractTrainer {

    public NamePetitionerlawerTrainer() {
        super(GrobidModels.NAMES_PETITIONERLAWER);
    }
	...
	public int createCRFPPData(final File corpusDir, 
		...
		try {
			...
			for (; n < refFiles.length; n++) {
				...
				final TEIPetitionerlawerSaxParser parser2 = new TEIPetitionerlawerSaxParser();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Trainer trainer = new NamePetitionerlawerTrainer();
