...
import org.grobid.trainer.sax.TEIPetitionerSaxParser;
...
public class NamePetitionerTrainer extends AbstractTrainer {

    public NamePetitionerTrainer() {
        super(GrobidModels.NAMES_PETITIONER);
    }
	...
	public int createCRFPPData(final File corpusDir, 
		...
		try {
			...
			for (; n < refFiles.length; n++) {
				...
				final TEIPetitionerSaxParser parser2 = new TEIPetitionerSaxParser();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Trainer trainer = new NamePetitionerTrainer();
