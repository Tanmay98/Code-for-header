...
import org.grobid.trainer.sax.TEIRespondentlawerSaxParser;
...
public class NameRespondentlawerTrainer extends AbstractTrainer {

    public NameRespondentlawerTrainer() {
        super(GrobidModels.NAMES_RESPONDENTLAWER);
    }
	...
	public int createCRFPPData(final File corpusDir, 
		...
		try {
			...
			for (; n < refFiles.length; n++) {
				...
				final TEIRespondentlawerSaxParser parser2 = new TEIRespondentlawerSaxParser();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Trainer trainer = new NameRespondentlawerTrainer();
