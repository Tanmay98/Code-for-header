...
public class TrainerRunner {
    ...
    private static final List<String> models = Arrays.asList("affiliation", "chemical", "date", "citation", "ebook", "fulltext", "header", "name-citation", "name-header", "name-petitioner", "name-respondent", "name-petitionerlawer", "name-respondentlawer","patent");
    ...
    public static void main(String[] args) {
        ...
        } else if (model.equals("name-petitioner")) {
            trainer = new NamePetitionerTrainer();
        } else if (model.equals("name-respondent")) {
            trainer = new NameRespondentTrainer();
        } else if (model.equals("name-petitionerlawer")) {
            trainer = new NamePetitionerlawerTrainer();
        } else if (model.equals("name-respondentlawer")) {
            trainer = new NameRespondentlawerTrainer();
