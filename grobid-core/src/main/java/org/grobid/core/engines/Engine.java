...
public class Engine implements Closeable {
     ...
     * reference markers.
     *
     * @param petitionerSequence - the string corresponding to a raw sequence of names
     * @return the list of structured author object
     */
    public List<Person> processPetitionersHeader(String petitionerSequence) throws Exception {
        List<Person> result = parsers.getPetitionerParser().processingHeader(petitionerSequence);
        return result;
    }
     ...
     * reference markers.
     *
     * @param respondentSequence - the string corresponding to a raw sequence of names
     * @return the list of structured author object
     */
    public List<Person> processRespondentsHeader(String respondentSequence) throws Exception {
        List<Person> result = parsers.getRespondentParser().processingHeader(respondentSequence);
        return result;
    }
     ...
     * reference markers.
     *
     * @param petitionerlawerSequence - the string corresponding to a raw sequence of names
     * @return the list of structured author object
     */
    public List<Person> processPetitionerlawersHeader(String petitionerlawerSequence) throws Exception {
        List<Person> result = parsers.getPetitionerlawerParser().processingHeader(petitionerlawerSequence);
        return result;
    }
     ...
     * reference markers.
     *
     * @param respondentlawerSequence - the string corresponding to a raw sequence of names
     * @return the list of structured author object
     */
    public List<Person> processRespondentlawersHeader(String respondentlawerSequence) throws Exception {
        List<Person> result = parsers.getRespondentlawerParser().processingHeader(respondentlawerSequence);
        return result;
    }
