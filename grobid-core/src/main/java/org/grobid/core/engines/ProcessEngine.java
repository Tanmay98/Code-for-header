...
public class ProcessEngine implements Closeable {
     ...
     * @throws Exception
     */
    public void processPetitionersHeader(final GrobidMainArgs pGbdArgs) throws Exception {
        inferOutputPath(pGbdArgs);
        final List<Person> result = getEngine().processPetitionersHeader(pGbdArgs.getInput());
        if (isEmpty(result)) {
            throw new GrobidResourceException("Cannot read the input data for processPetitionersHeader. Check the documentation. ");
        }
        IOUtilities.writeInFile(pGbdArgs.getPath2Output() + File.separator + "result", result.get(0).toTEI(false));
        LOGGER.info(result.get(0).toTEI(false));
     ...
     * @throws Exception
     */
    public void processRespondentsHeader(final GrobidMainArgs pGbdArgs) throws Exception {
        inferOutputPath(pGbdArgs);
        final List<Person> result = getEngine().processRespondentsHeader(pGbdArgs.getInput());
        if (isEmpty(result)) {
            throw new GrobidResourceException("Cannot read the input data for processRespondentsHeader. Check the documentation. ");
        }
        IOUtilities.writeInFile(pGbdArgs.getPath2Output() + File.separator + "result", result.get(0).toTEI(false));
        LOGGER.info(result.get(0).toTEI(false));
     ...
     * @throws Exception
     */
    public void processPetitionerlawersHeader(final GrobidMainArgs pGbdArgs) throws Exception {
        inferOutputPath(pGbdArgs);
        final List<Person> result = getEngine().processPetitionerlawersHeader(pGbdArgs.getInput());
        if (isEmpty(result)) {
            throw new GrobidResourceException("Cannot read the input data for processPetitionerlawersHeader. Check the documentation. ");
        }
        IOUtilities.writeInFile(pGbdArgs.getPath2Output() + File.separator + "result", result.get(0).toTEI(false));
        LOGGER.info(result.get(0).toTEI(false));
     ...
     * @throws Exception
     */
    public void processRespondentlawersHeader(final GrobidMainArgs pGbdArgs) throws Exception {
        inferOutputPath(pGbdArgs);
        final List<Person> result = getEngine().processRespondentlawersHeader(pGbdArgs.getInput());
        if (isEmpty(result)) {
            throw new GrobidResourceException("Cannot read the input data for processRespondentlawersHeader. Check the documentation. ");
        }
        IOUtilities.writeInFile(pGbdArgs.getPath2Output() + File.separator + "result", result.get(0).toTEI(false));
        LOGGER.info(result.get(0).toTEI(false));
